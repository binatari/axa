        ...
        <Label>
          ...
          <div className="relative">
            <input
              ...
              placeholder="Jane Doe"
            />
            <button className="absolute inset-y-0 px-4 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-custom-red-600 border border-transparent rounded-l-md active:bg-custom-red-600 hover:bg-custom-red-700 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
              Click
            </button>
          </div>
        </Label>
        ...
        <Label className="mt-4">
          ...
          <div className="relative text-gray-500 focus-within:text-purple-600">
            <input
              ...
              placeholder="Jane Doe"
            />
            <button className="absolute inset-y-0 right-0 px-4 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-custom-red-600 border border-transparent rounded-r-md active:bg-custom-red-600 hover:bg-custom-red-700 focus:outline-none focus:shadow-outline-purple">
              Click
            </button>
          </div>
        </Label>
